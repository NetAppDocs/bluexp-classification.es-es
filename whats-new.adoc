...
Para obtener más información, consulte link:https://docs.netapp.com/us-en/bluexp-classification/concept-cloud-compliance.html#whats-the-difference-between-mapping-and-classification-scans["¿Cuál es la diferencia entre las exploraciones de mapeo y clasificación"]
...
Ahora puede cargar su licencia BYOL de Data Sense en la cartera digital de BlueXP  en un sitio oscuro para que se le notifique cuando su licencia esté baja. https://docs.netapp.com/us-en/bluexp-classification/task-licensing-byol-freetrial.html#obtain-your-bluexp-classification-license-file["Vea cómo obtener y cargar su licencia BYOL de Data Sense"].
