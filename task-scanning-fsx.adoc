...
+
https://["Grupos de seguridad de AWS para instancias de Linux"^]

+
https://["Grupos de seguridad de AWS para instancias de Windows"^]

+
https://["Interfaces de red elásticas de AWS (ENI)"^]
...
Antes de poder analizar volúmenes FSX para ONTAP, https://["Debe tener un entorno de trabajo FSX con volúmenes configurados"^].
...
https://["Descubra cómo descubrir o crear el sistema de archivos FSX para ONTAP en BlueXP"^].
