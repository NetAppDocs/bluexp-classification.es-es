...
Cuando Data Sense escanea volúmenes que tienen datos inactivos organizados en niveles en el almacenamiento de objetos, analiza todos los datos: Los datos que hay en discos locales y los datos inactivos organizados en niveles en el almacenamiento de objetos. Esto también es aplicable a productos que no son de NetApp que implementan la organización en niveles.
