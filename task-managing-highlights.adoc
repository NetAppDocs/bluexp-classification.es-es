...
.Requisitos
* Debe tener permisos para copiar archivos. link:concept-cloud-compliance.html["Obtenga más información sobre el acceso de los usuarios a la información de cumplimiento normativo"] .
...
.Requisitos
* Debe tener permisos para copiar y sincronizar archivos. link:concept-cloud-compliance.html["Obtenga más información sobre el acceso de los usuarios a la información de cumplimiento normativo"] .
* Debe seleccionar un mínimo de 20 archivos.
...
.Requisitos
* Debe tener permisos para mover archivos. link:concept-cloud-compliance.html["Obtenga más información sobre el acceso de los usuarios a la información de cumplimiento normativo"] .
...
.Requisitos
* Debe tener permisos para eliminar archivos. link:concept-cloud-compliance.html["Obtenga más información sobre el acceso de los usuarios a la información de cumplimiento normativo"] .
