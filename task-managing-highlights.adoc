...
Esto resulta útil en situaciones en las que se migran datos de un sistema de origen a otro. Esta acción utiliza https://docs.netapp.com/us-en/cloud-manager-sync/concept-cloud-sync.html["Copia y sincronización de NetApp BlueXP"^] funcionalidad para copiar y sincronizar datos de un origen en un destino.
