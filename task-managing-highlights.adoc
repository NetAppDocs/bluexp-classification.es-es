...
Puede eliminar archivos manualmente desde el panel Investigación, o. link:task-using-policies.html#delete-source-files-automatically-using-policies["Uso automático de directivas"^].
