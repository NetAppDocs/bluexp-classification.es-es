...
[role="quick-margin-para"]
Hace falta una suscripción a BlueXP a través del mercado del proveedor de nube.
...
Los sistemas ONTAP en las instalaciones, los recursos compartidos de archivos de NetApp, el almacenamiento de objetos S3 genérico y las bases de datos se pueden analizar al usar cualquiera de estos conectores en la nube.
