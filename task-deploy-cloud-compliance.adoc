...
--
====
Asegúrese de que BlueXP tiene los permisos necesarios:: Asegúrese de que BlueXP tenga permisos para implementar recursos y crear grupos de seguridad para la instancia de BlueXP classification .
+
--
* link:https://docs.netapp.com/us-en/bluexp-setup-admin/reference-permissions-gcp.html["Permisos de Google Cloud"^]
* link:https://docs.netapp.com/us-en/bluexp-setup-admin/reference-permissions-aws.html#classification["Permisos de AWS"^]
* link:https://docs.netapp.com/us-en/bluexp-setup-admin/reference-permissions-azure.html#classification["Permisos de Azure"^]
