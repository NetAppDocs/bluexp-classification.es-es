...
Genere este informe desde la ficha Gobierno en el sentido de datos.
...
.Resultado
Data Sense genera un informe en PDF que puede revisar y enviar a otros grupos según sea necesario.
