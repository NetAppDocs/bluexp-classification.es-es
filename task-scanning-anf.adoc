...
Antes de poder analizar volúmenes Azure NetApp Files, https://["Debe configurar BlueXP para descubrir la configuración"^].
...
https://["Descubra cómo descubrir el sistema Azure NetApp Files en BlueXP"^].
