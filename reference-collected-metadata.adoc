...
Si es necesario, puede exportar estos resultados a un informe para poder ver qué archivos se están analizando o no debido a permisos. https://["Obtenga más información sobre el informe de investigación de datos"^].
