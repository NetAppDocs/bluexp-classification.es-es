...
* Recursos compartidos de archivos (por ejemplo, Dell EMC Isilon, Pure Storage, Nutanix, etc.)
* Bases de datos:
+
...
La clasificación de BlueXP ahora es gratuita para hasta 500 TiB de datos. No se requiere licencia de clasificación ni suscripción de pago. Si tiene más de 500 TiB de datos que desea analizar, puede deshabilitar el análisis en algunos de sus sistemas originales y escanear los nuevos sistemas que, de lo contrario, superarían el límite de 500 TiB.
