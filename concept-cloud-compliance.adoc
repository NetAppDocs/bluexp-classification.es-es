...
=== Despliegue en distintos tipos de instancia
...
* *Metadatos estándar* La clasificación de BlueXP recopila metadatos estándar sobre los archivos: El tipo de archivo, su tamaño, fechas de creación y modificación, etc.
