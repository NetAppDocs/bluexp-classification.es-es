...
....
+
Si activa `firewalld` Tras instalar la clasificación de BlueXP, debes reiniciar docker.
...
.. Introduzca la dirección IP o el nombre de host de la máquina host de clasificación de BlueXP para que la instancia de Connector pueda acceder a ellos.
.. Introduzca la dirección IP o el nombre de host de la máquina host de BlueXP Connector para que se pueda acceder a ellos mediante la instancia de clasificación de BlueXP.
