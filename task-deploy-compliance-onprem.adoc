...
summary: Complete unos pasos para instalar Data Sense en un host Linux de su red, o en un host Linux en la nube, que tenga acceso a Internet. Deberá implementar el host Linux manualmente en su red o en el cloud como parte de esta instalación. 
---
...
[role="lead"]
Complete unos pasos para instalar Data Sense en un host Linux de su red, o en un host Linux en la nube, que tenga acceso a Internet. Deberá implementar el host Linux manualmente en su red o en el cloud como parte de esta instalación.
...
Si aún no tiene un conector, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-on-prem.html["Ponga en marcha el conector en las instalaciones"^] En un host Linux de su red o en un host Linux del cloud.
...
* Al crear el sistema host en sus instalaciones, puede elegir entre tres tamaños de sistema en función del tamaño del conjunto de datos que desee que tenga un análisis de detección de datos:
+
[cols="18,18,26,30"]
|===
...
** Si el proxy está realizando intercepción TLS, deberá conocer la ruta en el sistema Data Sense Linux donde están almacenados los certificados de CA TLS.
