...
*** Rocky Linux 9 (requiere una versión de clasificación de BlueXP 1,24 o posterior)
...
| Conector Clasificación de <> BlueXP | 8080 (TCP), 6000 (TCP), 443 (TCP) Y 80 | El grupo de seguridad del Connector debe permitir el tráfico de entrada y salida a través de los puertos 6000 y 443 hacia y desde la instancia de clasificación de BlueXP.

Asegúrese de que el puerto 8080 está abierto para que pueda ver el progreso de la instalación en BlueXP. 
