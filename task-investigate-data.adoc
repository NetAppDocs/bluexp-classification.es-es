...
. Si eligió CSV para el tipo de informe, seleccione **Local** para descargar el informe en el navegador. Nota Esta opción limita el informe a las primeras 10.000 filas. No se requieren otras opciones con esta opción.
+
Para el informe completo, seleccione **Entorno de trabajo** y, a continuación, elija **Entorno de trabajo** y **Volumen** en los menús desplegables correspondientes. Proporcione una **Ruta de carpeta de destino**.
