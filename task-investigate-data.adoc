...
El informe está disponible como . Archivo CSV que puede guardar en la máquina local.
...
. Seleccione esta opción para descargar una . Informe CSV de los datos y haga clic en *Descargar informe*.
+
