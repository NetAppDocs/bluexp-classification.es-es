...
También puede hacerlo link:task-licensing-datasense.html["Configura las licencias de BYOL para la clasificación de BlueXP"] Desde la página de la cartera digital de BlueXP en este momento. No se le cobrará incluso después de que finalice su prueba gratuita de 30 días.
